...
const form = useForm({
    ...
    price_cents: props.service.price_cents,
    currency: props.service.currency as SupportedCurrency,
    color: props.service.color,
    buffer_minutes: props.service.buffer_minutes,
...
<template>
    <Head :title="`Edit ${service.name} — BookFlow`" />
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Update the details of <span class="font-medium">{{ service.name }}</span>.
                    </p>
                </div>
            </div>
        </template>
